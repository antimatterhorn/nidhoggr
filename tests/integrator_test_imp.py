...
if __name__ == "__main__":
    ...
    constantGravity = ImplicitPhysics2d(myNodeListEul,constants)
    ...
    constantGravity = ImplicitPhysics2d(myNodeListRK2,constants)
    packages = [constantGravity]
    ...
    constantGravity = ImplicitPhysics2d(myNodeListRK4,constants)
    packages = [constantGravity]
    ...
    constantGravity = ImplicitPhysics2d(myNodeListCN,constants)
    packages = [constantGravity]
